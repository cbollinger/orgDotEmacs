...
** Org Custom Agenda View                         :dg_agenda_view:
...
** COMMENT Org Custom Agenda View                         :dg_agenda_view:
...
** Org Capture Templates                           :dg_agenda_view:
...
for gnome: org-attach-screenshot-command-line "gnome-screenshot -a -f %f")
#+begin_src emacs-lisp
