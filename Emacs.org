...
#+begin_src emacs-lisp
  ...
  ;; (use-
   package treemacs-persp ;;treemacs-perspective if you use perspective.el vs. persp-mode
...
set =org-todo-state-tags-triggers=
#+begin_src emacs-lisp
  (use-package org
...
set =org-fast-tag-selection=, Allow setting single tags without the menu
set =org-agenda-tags-todo-honor-ignore=, For tag searches ignore tasks with scheduled and deadline dates
#+begin_src emacs-lisp
    (use-package org
      :config 
...
Spell Checker, =flyspell-mode= for spell checking everywhere
#+begin_src emacs-lisp
  (use-package org
...
set =org-finalize-agenda-hook=, Place tags close to the right-hand side of the window
#+begin_src emacs-lisp
    (use-package org
      :config 
