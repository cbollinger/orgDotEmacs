...
(use-package org
  ...
  (setq org-directory "/home/christian/Daten/org-system/org-mode")
  (setq org-default-notes-file "/home/christian/Daten/org-system/org-mode/refile/refile.org")
  (setq org-agenda-files (quote ("/home/christian/Daten/org-system/org-mode/refile"
				 "/home/christian/Daten/org-system/org-mode/private"
				 "/home/christian/Daten/org-system/org-mode/gnu-software"
				 "/home/christian/Daten/org-system/org-mode/duagon/General"
				 "/home/christian/Daten/org-system/org-mode/duagon/Clients"
				 "/home/christian/Daten/org-system/org-mode/duagon/Products")))
  ...
  (setq org-capture-templates
	(quote (("t" "todo" entry (file "/home/christian/Daten/org-system/org-mode/refile/todo.org")
		 "* TODO [#A] %?\n%U\n%a\n" :clock-in t :clock-resume t)
		("r" "respond" entry (file "/home/christian/Daten/org-system/org-mode/refile/refile.org")
		 "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
		("n" "note" entry (file "/home/christian/Daten/org-system/org-mode/refile/note.org")
		 "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
		("j" "Journal" entry (file+datetree "/home/christian/Daten/org-system/org-mode/refile/journal.org")
		 "* %?\n%U\n" :clock-in t :clock-resume t :tree-type month)
		("w" "org-protocol" entry (file "/home/christian/Daten/org-system/org-mode/refile/refile.org")
		 "* TODO Review %c\n%U\n" :immediate-finish t)
		("m" "Meeting" entry (file "/home/christian/Daten/org-system/org-mode/refile/meeting.org")
		 "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
		("p" "Phone call" entry (file "/home/christian/Daten/org-system/org-mode/refile/phone.org")
		 "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
		("h" "Habit" entry (file "/home/christian/Daten/org-system/org-mode/refile/habit.org")
...
(use-package elfeed-org
  ...
  :config
  (elfeed-org)
  (setq rmh-elfeed-org-files (list "/home/christian/Daten/org-system/org-mode/refile/elfeed.org"))
)
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-attach-screenshot yasnippet-snippets xref-js2 which-key vterm use-package undo-tree typescript-mode treemacs-tab-bar treemacs-projectile treemacs-persp treemacs-magit treemacs-icons-dired sourcemap restclient request rainbow-delimiters ox-reveal org-tree-slide org-present org-bullets no-littering lsp-ui lsp-treemacs lsp-ivy json-mode ivy-rich ivy-prescient indium hide-mode-line helpful gnuplot forge evil-nerd-commenter eterm-256color eshell-git-prompt elfeed-org doom-themes doom-modeline dired-single dired-open dired-hide-dotfiles counsel-projectile command-log-mode ccls auto-package-update all-the-icons-dired @)))
(custom-set-faces
