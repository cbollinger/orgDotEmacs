...
(setq org-emphasis-alist
  ...
  (add-hook 'org-clock-out-hook 'bh/clock-out-maybe 'append)
    ...
    (setq org-latex-default-packages-alist
        ...
        ;; saving one xelatex pass on every build.
    ...
    ;; Use latexmk + xelatex. Shell-escape and interaction flags are defined
    ;; in ~/.latexmkrc to keep a single source of truth.
...
(add-hook 'org-export-before-processing-hook #'my-org-set-headline-function-based-on-class)
  ...
  (setq org-confirm-babel-evaluate nil)     ;; no security check
  (setq org-src-preserve-indentation t)     ;; start at column 0
  (setq org-edit-src-content-indentation 0) 
  (setq python-indent-offset 4)             ;; offset for python 4 
  (setq python-shell-interpreter "python3") ;; set python shell interpreter
